...
//10. Revise the BankAccount class of Example 5.1 to overload the Withdraw method.
...
namespace Exercise5_10
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (yourAccount.Withdraw() < 0)
                Console.WriteLine("Insufficient funds");
            Console.WriteLine("My balance = {0:C}", yourAccount.GetBalance());
